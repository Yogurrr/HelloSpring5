...
public class HelloSpring5App05 {
    ...
    public static void main(String[] args) {
        ...
        // path 이름과 똑같이 src 에서 xml 구성 파일을 만들어야 함

        HelloSpring5Bean03 bean05 = null;

        bean05 = (HelloSpring5Bean03) bf.getBean("Kor");
        bean05.sayHello("스프링 5");

        bean05 = (HelloSpring5Bean03) bf.getBean("Eng");
        bean05.sayHello("Spring 5");

        bean05 = (HelloSpring5Bean03) bf.getBean("Jpn");
        bean05.sayHello("スプリング 5");
    }
}
