...
import yogurrr.annotation.HelloSpring5Bean07;
...
public class HelloSpring5App07 {
    ...
    public static void main(String[] args) {
        ...
        HelloSpring5Bean07 bean07 = null;

        bean07 = (HelloSpring5Bean07) ctx.getBean("Kor");
        bean07.sayHello("스프링 5");

        bean07 = (HelloSpring5Bean07) ctx.getBean("Eng");
        bean07.sayHello("Spring 5");

        bean07 = (HelloSpring5Bean07) ctx.getBean("Jpn");
        bean07.sayHello("スプリング 5");
    }
}
