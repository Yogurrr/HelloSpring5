...
public class HelloSpring5App04 {
    ...
    public static void main(String[] args) {
        HelloSpring5Bean03 bean04 = null;

        bean04 = HelloSpring5BeanFactory04.create("Kor");
        bean04.sayHello("스프링 5");

        bean04 = HelloSpring5BeanFactory04.create("Eng");
        bean04.sayHello("Spring 5");

        bean04 = HelloSpring5BeanFactory04.create("Jpn");
        bean04.sayHello("スプリング 5");
    }
}
